...
`May 2026 – Present · 2 mos · Part-time`
...
### 🏢 ServiceNow Virtual Intern — ServiceNow
`Apr 2026 – May 2026 · 2 mos · Remote`
...
### 📊 Data Analyst — Kanchan Welfare & Educational Society
`Nov 2025 – Dec 2025 · 2 mos · On-site`
...
### 🏢 Data Science Intern — CodSoft (Virtual)
`Jan 2024 – Feb 2024 · 2 mos · Remote`
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>🧠 MedAgent — AI Medical Assistant</h3>
      <p>RAG-powered medical AI chatbot with Llama 3 via Groq API. Context-aware multi-turn dialogue with conversation memory. Live on Streamlit Cloud.</p>
      <p>
        <img src="https://img.shields.io/badge/RAG-8E2DE2?style=flat-square"/>
        <img src="https://img.shields.io/badge/Llama_3-FF6B6B?style=flat-square"/>
        <img src="https://img.shields.io/badge/Groq_API-00A67E?style=flat-square"/>
    ...
    <td width="50%" valign="top">
      <h3>🚗 CarpoolPal — AI Ride Sharing</h3>
      <p>Full-stack carpooling app with JWT auth, AI fare prediction (Random Forest on 1000+ samples), Haversine distance calculation & REST APIs.</p>
      <p>
        <img src="https://img.shields.io/badge/FastAPI-009688?style=flat-square&logo=fastapi&logoColor=white"/>
        <img src="https://img.shields.io/badge/MongoDB-4EA94B?style=flat-square&logo=mongodb&logoColor=white"/>
        <img src="https://img.shields.io/badge/React-61DAFB?style=flat-square&logo=react&logoColor=black"/>
        <img src="https://img.shields.io/badge/Random_Forest-8E2DE2?style=flat-square"/>
      </p>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p>End-to-end data analytics project — EDA, SQL-based segmentation, revenue analysis & interactive Power BI dashboard for business insights.</p>
      <p>
...
![RAG](https://img.shields.io/badge/RAG-8E2DE2?style=for-the-badge)
![LLMs](https://img.shields.io/badge/LLMs-FF6B6B?style=for-the-badge)
![Groq API](https://img.shields.io/badge/Groq_API-00A67E?style=for-the-badge)
![Llama 3](https://img.shields.io/badge/Llama_3-4A00E0?style=for-the-badge)
...
<table>
  <tr>
    <td>🤖</td>
    <td><b>Artificial Intelligence Fundamentals</b></td>
    <td>IBM Skills Build (2024)</td>
  </tr>
  <tr>
    <td>🐍</td>
    <td><b>Applied Machine Learning in Python</b></td>
    <td>University of Michigan — Coursera (2023)</td>
  </tr>
  <tr>
    <td>📐</td>
    <td><b>MATLAB Fundamentals</b></td>
    <td>MathWorks (2024)</td>
  </tr>
  <tr>
    <td>☁️</td>
    <td><b>AWS Solutions Architecture Job Simulation</b></td>
    <td>Forage — Amazon Web Services (2023)</td>
  </tr>
  <tr>
    <td>📦</td>
    <td><b>Introduction to Data Engineering & Bigdata</b></td>
    <td>HCL GUVI (2025)</td>
  </tr>
  <tr>
    <td>🤖</td>
    <td><b>Claude in Action</b></td>
    <td>Anthropic (2025)</td>
  </tr>
  <tr>
    <td>📊</td>
    <td><b>Power BI Micro Course</b></td>
    <td>IBM — Coursera (2025)</td>
  </tr>
</table>
